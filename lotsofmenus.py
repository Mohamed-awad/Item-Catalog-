...
menuItem2 = MenuItem(user_id=1,
                     ...
                     "Beijing[1] that has been prepared since the "\
                     "imperial era. The meat is prized"\
                     " for its thin, crisp skin,"\
                     " with authentic versions of the dish "\
                     "serving mostly the skin and little"\
...
menuItem6 = MenuItem(user_id=1,
                     ...
                     "fish-based broth, often flavored with soy "\
...
menuItem3 = MenuItem(user_id=1,
                     ...
                     "Japanese gyoza with salt and"\
                     " soy sauce, and in a thin gyoza wrapper",
                     price="$9.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     " cake soaked in sweet milk "\
                     "and topped with vanilla bean whipped"\
...
menuItem4 = MenuItem(user_id=1,
                     ...
                     " florets in a midly spiced"\
                     " soya,garlic sauce cooked with fresh cilantro, celery,"\
...
menuItem5 = MenuItem(user_id=1,
                     ...
                     "garbanzo beans, curry sauce, "\
                     "potatoes (aloo), fried cauliflower "\
...
menuItem4 = MenuItem(user_id=1,
                     name="Nigiri Sampler",
                     description="Maguro, Sake, Hamachi, "\
                     "Unagi, Uni, TORO!",
                     price="$6.75",
                     course="Appetizer",
                     restaurant=restaurant1)
...
menuItem2 = MenuItem(user_id=1,
                     ...
                     "with fresh herbs and broiled hot & fast",
                     price="$10.95",
                     course="Entree",
                     restaurant=restaurant1)
...
menuItem4 = MenuItem(user_id=1,
                     ...
                     "and seasoned with a "\
                     "spicy mix(chilli, tamarind among others) "\
                     "and slow cooked in a"\
                     " cylindrical clay or metal oven which gets"\
...
menuItem1 = MenuItem(user_id=1,
                     ...
                     description="Lemon Curd Ice Cream "\
                     "Sandwich on a chocolate macaron"\
